    ...
    if payload['current_wread'] and payload['a_one_wread'] and payload['a_two_green'] and payload['a_two_opens'] > payload['a_one_closing']:
        ...
        if payload['a_three_opens'] > payload['a_one_closing'] and payload['a_three_green']:
            ...
            if payload['a_four_wread'] and payload['a_four_opens'] > payload['a_two_closing']:
                ...
                if payload['a_five_green'] and payload['a_five_opens'] > payload['a_four_closing']:
                    print("bear_one_two_six_one_one")
                if payload['a_five_green'] and payload['current_closing'] < payload['a_five_opens'] < payload['a_four_closing']:
                    print("bear_one_two_six_one_two")
                if payload['a_five_wread'] and payload['a_five_opens'] < payload['a_two_closing']:
                    print("bear_one_two_six_one_three")
                if payload['a_five_wread'] and payload['a_five_opens'] > payload['a_two_closing']:
                    print("bear_one_two_six_one_four>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")

            if payload['a_four_green'] and payload['a_four_opens'] > payload['current_closing']:
                print("bear_one_two_six_two")
                if payload['a_five_green'] and payload['a_five_opens'] > payload['a_four_closing']:
                    print("bear_one_two_six_two_one")
                if payload['a_five_green'] and payload['a_five_opens'] < payload['current_closing']:
                    print("bear_one_two_six_two_two")
                if payload['a_five_wread'] and payload['a_five_opens'] < payload['current_closing']:
                    print("bear_one_two_six_two_three")
                if payload['a_five_wread'] and payload['a_five_opens'] > payload['current_closing']:
                    print("bear_one_two_six_two_four>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
        ...
        if payload['a_three_wread'] and payload['a_three_opens'] > payload['a_two_closing']:
            ...
            if payload['a_four_wread'] and payload['a_two_closing'] > payload['a_four_opens'] > payload['current_closing']:
                print("bear_one_four_three")

        if payload['a_three_wread'] and payload['a_three_opens'] > payload['a_two_closing']:
            print("bear_one_five")
            if payload['a_four_green'] and payload['a_four_opens'] < payload['a_two_closing']:
                print("bear_one_five_one")
            if payload['a_four_wread'] and payload['a_two_closing'] > payload['a_four_opens'] > payload['a_three_closing']:
                print("bear_one_five_two")
            if payload['a_four_green'] and payload['a_four_opens'] > payload['a_two_closing']:
                print("bear_one_five_three")

    if payload['current_wread'] and payload['a_two_wread'] and payload['a_one_green'] and payload['a_two_opens'] < payload['a_one_closing']:
        print("bear_two")

        if payload['a_three_wread'] and payload['current_closing'] > payload['a_three_opens'] > payload['a_one_closing']:
            print("bear_two_one")
            ...
            if payload['a_four_green'] and payload['a_four_opens'] > payload['a_three_closing']:
                ...
                if payload['a_five_green'] and payload['a_five_opens'] < payload['a_two_closing']:
                    print("bear_two_one_one_one")
                    print("Greening from here>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_one_one_one")
                        print("Resultant option:", resultant_option)
                        return resultant_option
                if payload['a_five_wread'] and payload['current_closing'] > payload['a_five_opens'] > payload['a_four_closing']:
                    print("bear_two_one_one_two")
                if payload['a_five_wread'] and payload['a_five_opens'] > payload['a_three_closing']:
                    print("bear_two_one_one_three")
                    print("Greening from here>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_one_one_three")
                        print("Resultant option:", resultant_option)
                        return resultant_option
                if payload['a_five_green'] and payload['a_two_closing'] < payload['a_five_opens'] < payload['a_three_closing']:
                    print("bear_two_one_one_four")
                    print("Greening from here>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_one_one_four")
                        print("Resultant option:", resultant_option)
                        return resultant_option
            ...
            if payload['a_four_green'] and payload['a_two_closing'] < payload['a_four_opens'] < payload['a_three_closing']:
                ...
                if payload['a_five_wread'] and payload['a_five_opens'] < payload['a_four_closing']:
                    print("bear_two_one_two_one")
                    print("Greening from here>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_one_two_one")
                        print("Resultant option:", resultant_option)
                        return resultant_option
                if payload['a_five_green'] and payload['current_closing'] > payload['a_five_opens'] > payload['a_four_closing']:
                    print("bear_two_one_two_two")
                if payload['a_five_wread'] and payload['a_two_closing'] < payload['a_five_opens'] < payload['a_three_closing']:
                    print("bear_two_one_two_three")
                    print("Greening from here>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_one_two_three")
                        print("Resultant option:", resultant_option)
                        return resultant_option
            ...
            if payload['a_four_wread'] and payload['a_four_opens'] > payload['a_three_closing']:
                ...
                if payload['a_five_green'] and payload['current_closing'] > payload['a_five_opens'] > payload['a_two_closing']:
                    print("bear_two_one_three_one")
                    print("Greening from here>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_one_three_one")
                        print("Resultant option:", resultant_option)
                        return resultant_option
                if payload['a_five_green'] and payload['a_five_opens'] < payload['current_closing']:
                    print("bear_two_one_three_two")
                    print("Greening from here>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_one_three_two")
                        print("Resultant option:", resultant_option)
                        return resultant_option
                if payload['a_five_wread'] and payload['a_five_opens'] > payload['a_two_closing']:
                    print("bear_two_one_three_three")
                    print("Greening from here>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_one_three_three")
                        print("Resultant option:", resultant_option)
                        return resultant_option
            ...
            if payload['a_four_wread'] and payload['a_two_closing'] < payload['a_four_opens'] < payload['a_three_closing']:
                ...
                if payload['a_five_wread'] and payload['a_five_opens'] < payload['a_four_closing']:
                    print("bear_two_one_four_one")
                if payload['a_five_green'] and payload['a_two_closing'] < payload['a_five_opens'] < payload['a_four_closing']:
                    print("bear_two_one_four_two")
                if payload['a_five_green'] and payload['a_five_opens'] < payload['a_four_closing']:
                    print("bear_two_one_four_three")

            if payload['a_four_green'] and payload['a_four_opens'] > payload['current_closing']:
                print("bear_two_one_five")
        ...
        if payload['a_three_green'] and payload['a_three_opens'] < payload['a_one_closing']:
            ...
            if payload['a_four_wread'] and payload['current_closing'] > payload['a_four_opens'] > payload['a_three_closing']:
                ...
                if payload['a_five_wread'] and payload['current_closing'] > payload['a_five_opens'] > payload['a_four_closing']:
                    ...
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_two_one_one")
                        print("Resultant option:", resultant_option)
                        return resultant_option
                if payload['a_five_green'] and payload['a_two_closing'] < payload['a_five_opens'] < payload['a_three_closing']:
                ...
                if payload['a_five_wread'] and payload['a_five_opens'] < payload['a_three_closing']:
                    ...
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_two_one_three")
                        print("Resultant option:", resultant_option)
                        return resultant_option
            ...
            if payload['a_four_wread'] and payload['a_two_closing'] < payload['a_four_opens'] < payload['a_three_closing']:
                ...
                if payload['a_five_wread'] and payload['a_five_opens'] < payload['a_three_closing']:
                    ...
                    if connection_data:
                        resultant_option = pickup_fromstream(connection_obj, connection_data, "CE")
                        greenery_recording(payload['current_closing'], timeofcalling, True, 'two', "bear_two_two_two_two")
                        print("Resultant option:", resultant_option)
                        return resultant_option
        ...
        if payload['a_three_wread'] and payload['a_three_opens'] > payload['a_one_closing']:
            ...
            if payload['a_four_green'] and payload['current_closing'] > payload['a_four_opens'] > payload['a_two_closing']:
                print("bear_two_three_one")
            if payload['a_four_wread'] and payload['current_closing'] > payload['a_four_opens'] > payload['a_two_closing']:
        ...
        if payload['a_three_wread'] and payload['a_three_opens'] > payload['a_two_closing']:
            print("bear_two_four")
            if payload['a_four_green'] and payload['a_four_opens'] > payload['a_two_closing']:
                print("bear_two_four_one")
            if payload['a_four_wread'] and payload['a_four_opens'] > payload['a_two_closing']:
                print("bear_two_four_two")
            if payload['a_four_green'] and payload['current_closing'] < payload['a_four_opens'] < payload['a_two_closing']:
                print("bear_two_four_three")

        if payload['a_three_wread'] and payload['a_three_opens'] < payload['a_two_closing']:
            print("bear_two_five")
            if payload['a_four_green'] and payload['a_four_opens'] > payload['current_closing']:
                print("bear_two_five_one")
            if payload['a_four_wread'] and payload['a_four_opens'] > payload['a_two_closing']:
                print("bear_two_five_two")
            if payload['a_four_green'] and payload['a_four_opens'] < payload['a_two_closing']:
                print("bear_two_five_three")
